...
module "eks_infrastructure_instance" {
  source = "./eks_infrstructure/"

  eks_private_subnet_list = [aws_subnet.private_subnet_1.id, aws_subnet.private_subnet_2.id]
  eks_public_subnet_list  = [aws_subnet.public_subnet_1.id, aws_subnet.public_subnet_2.id]
}
